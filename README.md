...
## Environments
- Preview: https://main--maji-sp-2--aemysites.aem.page/
- Live: https://main--maji-sp-2--aemysites.aem.live/
- Block Library: https://main--maji-sp-2--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `maji-sp-2` directory in your favorite IDE and start coding :)
